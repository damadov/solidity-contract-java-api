...
public class XCLAIM extends Contract {
    ...
    public static final String FUNC_GETREWARD = "getHolderReward";
    
    public static final String FUNC_SETREWARD = "createReward";
    
    public static final String FUNC_SETREWARDS = "createRewards";
    ...
    public static final Event REWARD_EVENT = new Event("NewTokenReward", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Uint256>(true) {}));
    ;

    @Deprecated
    protected XCLAIM(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected XCLAIM(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected XCLAIM(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected XCLAIM(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<BigInteger> getHolderReward(String _holder) {
    ...
    public RemoteCall<TransactionReceipt> setReward(String _to, BigInteger weiValue) {
        final Function function = new Function(FUNC_SETREWARD, 
        		 Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_to), 
        				 			 new org.web3j.abi.datatypes.generated.Uint256(weiValue)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    
    public RemoteCall<TransactionReceipt> setRewards(String[] _holders, BigInteger[] _amounts) {
    	
    	List<Address> toAddressList = new ArrayList<Address>();
    	List<Uint256> toRewards = new ArrayList<Uint256>();
    			
    	for(int i=0;i<_holders.length;i++) {
    		toAddressList.add(new org.web3j.abi.datatypes.Address(_holders[i]));
    		toRewards.add(new org.web3j.abi.datatypes.generated.Uint256(_amounts[i]));
    	}
    	
    	
    	List<Type> inputParameters = new ArrayList<>();
        inputParameters.add(new DynamicArray(toAddressList));
        inputParameters.add(new DynamicArray(toRewards));

        
        final Function function = new Function(FUNC_SETREWARDS, 
        		inputParameters,
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    @Deprecated
    public static XCLAIM load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new XCLAIM(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static XCLAIM load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new XCLAIM(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static XCLAIM load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new XCLAIM(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static XCLAIM load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new XCLAIM(contractAddress, web3j, transactionManager, contractGasProvider);
    }
    ...
    public static class NewTokenReward {
        public String vestingWallet;
